...
/**
    ...
    Describe your class and how it works here!
                                                                    //[/Comments]
*/
class EQKnobs  : public juce::Component,
                 public juce::Slider::Listener
{
public:
    //==============================================================================
    EQKnobs (Graphical_equaliserAudioProcessor& p);
    ~EQKnobs() override;
...
private:
    Graphical_equaliserAudioProcessor& processor;
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (EQKnobs)
};
