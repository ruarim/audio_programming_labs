...
//==============================================================================
EQKnobs::EQKnobs (Graphical_equaliserAudioProcessor& p) : processor(p)
{
...
//==============================================================================
void EQKnobs::paint (juce::Graphics& g)
{
...
void EQKnobs::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
...
<JUCER_COMPONENT documentType="Component" className="EQKnobs" componentName=""
