...
//==============================================================================
EQControls::EQControls (Graphical_equaliser_4AudioProcessor& p)
    : processor(p)
{
...
void EQControls::sliderValueChanged (juce::Slider* sliderThatWasMoved)
{
    ...
    // use of shared pointer not ideal
    std::shared_ptr<EQFilters> eq = processor.eq;   // get a pointer to EQFilter object from the processor reference
...
<JUCER_COMPONENT documentType="Component" className="EQControls" componentName=""
                 parentClasses="public juce::Component" constructorParams="Graphical_equaliser_4AudioProcessor&amp; p"
